		...
		<div class="col-md-12">
			...
			<div class="carousel-inner">
                            <div class="carousel-item active">
                                <img class="d-block w-100 img-responsive" src="img/Inversiones1.jpg" alt="Primer slide">
                            </div>
			</div>
                    </div>
		</div>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 coll ">
                                        <div class="card mb-3 shadow-sm">
                                            <form id='acciones' action="Controlador" method="post">
                                                ...
                                                <div class="card-body">
                                                    <a href="javascript:;" onclick="document.getElementById('acciones').submit();"><h6 class="text-center fs-5">ACCIONES</h6></a> 
                                                </div>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 coll ">
                                        <div class="card mb-3 shadow-sm">
                                            <form id='bonos' action="Controlador" method="post">
                                                ...
                                                <div class="card-body">
                                                    <a href="javascript:;" onclick="document.getElementById('bonos').submit();"><h6 class="text-center fs-5">BONOS</h6></a> 
                                                </div>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 coll ">
                                        <div class="card mb-3 shadow-sm">
                                            <form id='criptos' action="Controlador" method="post">
                                                ...
                                                <div class="card-body">
                                                    <a href="javascript:;" onclick="document.getElementById('criptos').submit();"><h6 class="text-center fs-5">CRIPTOMONEDAS</h6></a> 
                                                </div>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 coll ">
                                        <div class="card mb-3 shadow-sm">
                                            <form id='opciones' action="Controlador" method="post">
                                                ...
                                                <div class="card-body">
                                                    <a href="javascript:;" onclick="document.getElementById('dolar').submit();"><h6 class="text-center fs-5">DOLAR</h6></a> 
                                                </div>
