...
import modelo.Dolar;
import modelo_Dao.DolarDao;
import modelo_Dao.DolarDaoImpl;


public class RecargarDolar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                listdolar = ddao.listarDolar();
                
                if (listdolar == null || listdolar.isEmpty()) {
                ...
                String jsonconFormato = prettyGson.toJson(listdolar);
                out.println(jsonconFormato);
                //System.out.println(jsonconFormato)

            } catch (SQLException e) {
                    System.out.println("==== ERROR EN RecargarDolar===="); //Muestro error por consola para Depuración
