...
<body class="d-flex flex-column h-100">
	...
	<ol class="breadcrumb align-items-center">
        ...
        <div class="row align-items-center">
            <div class="col col-lg-12" style="padding-left: 5%; padding-right: 5%; ">
        ...
        <div class="container mt-5 d-flex justify-content-center">
            <div class="alert alert-danger w-75 text-center" role="alert" id="mensaje-error-graficos" style="display:none;">
                ...
                <p id="texto-error-grafico">
                    No pudimos mostrar el gráfico histórico de: <strong>bono</strong>
                </p>
                <hr>
       ...
       <ol class="breadcrumb align-items-center" style="margin-bottom: 0px;">
        ...
        <div class="row d-flex justify-content-center"style="margin-bottom: 30px;">
            <div class="btn-group" role="group" aria-label="Basic example">
                <input type="button" id="30" value="30 Días" disabled onclick="treintaDiasb();"class="btn btn-secondary ">
                <input type="button" id="80" value="80 Días" disabled onclick="ochentaDiasb();"class="btn btn-secondary">
                <input type="button" id="180" value="180 Días" disabled onclick="cientoOchentaDiasb();"class="btn btn-secondary">
                <input type="button" id="365" value="1 Año" disabled onclick="unob();"class="btn btn-secondary">
            </div> 
        </div>          
        <div class="row align-items-center" >
    ...
    <!--------------------scripts carga datos-------------------------------------------->
    <script type="text/javascript" src="js/dt-bonos.js"></script>
    <!--------------------scripts Datatable---------------------------------------------->
