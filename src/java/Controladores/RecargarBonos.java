...
import modelo.Bono;
import modelo_Dao.BonoDao;
import modelo_Dao.BonoDaoImpl;


public class RecargarBonos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                String jsonconFormato = prettyGson.toJson(bonos);
                out.println(jsonconFormato);
                //System.out.println(jsonconFormato);
                } catch (SQLException e) {
                    System.out.println("==== ERROR EN RecargarBonos ===="); //Muestro error por consola para Depuración
